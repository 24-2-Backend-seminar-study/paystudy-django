...
def set_token_on_response_cookie(user, status_code) -> Response:
    ...
    res.set_cookie("refresh_token", samesite='None', secure=True, value=str(token))
    res.set_cookie("access_token", samesite='None', secure=True, value=str(token.access_token))
    return res
